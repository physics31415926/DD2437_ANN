...
# Output layer
[prediction, weight2] = add_layer(hidden_layer1, hidden_layer1_len, 1, activation_function=None)

# Training
step = 0.01
reg_str = 0.1
reg_item = tf.reduce_sum(tf.reduce_sum(tf.multiply(weight1, weight1)))+tf.reduce_sum(tf.reduce_sum(tf.multiply(weight2, weight2)))
