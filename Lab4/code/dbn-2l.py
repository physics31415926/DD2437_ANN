...
class DeepBeliefNet():
    ...
    def recognize(self, true_img, true_lbl):
        ...
        in3 = np.concatenate((lbl, out1), axis=1)
    ...
    def generate(self, true_lbl, name):
        ...
        out1 = self.rbm_stack['vis--pen'].get_h_given_v_dir(random_img)[1]
        in3 = np.concatenate((lbl, out1), axis=1)
    ...
    def train_greedylayerwise(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try:
            ...
            """
            self.vis_pen_errors = self.rbm_stack["vis--pen"].cd1(vis_trainset, n_iterations)
            ...
            in3 = np.concatenate((lbl_trainset, out1), axis=1)
    ...
    def train_wakesleep_finetune(self, vis_trainset, lbl_trainset, n_iterations):
        ...
        try:
            ...
            for it in range(n_iterations):
                ...
                vis_pen_out_p, vis_pen_out = self.rbm_stack['vis--pen'].get_h_given_v_dir(vis_batch)
                pen_top_in = np.concatenate((lbl_batch, vis_pen_out), axis=1)
                ...
                pen_vis_out_p, pen_vis_out = self.rbm_stack['vis--pen'].get_v_given_h_dir(v_k[:, n_labels:])
                ...
                pred_sleep_pen_p, pred_sleep_pen = self.rbm_stack['vis--pen'].get_h_given_v_dir(pen_vis_out_p)
                pred_wake_hid_p, pred_wake_hid = self.rbm_stack['vis--pen'].get_v_given_h_dir(vis_pen_out)

                # [TODO TASK 4.3] update generative parameters : here you will only use 'update_generate_params' method from rbm class.
                self.rbm_stack['vis--pen'].update_generate_params(vis_pen_out, vis_batch, pred_wake_hid_p)
                ...
                self.rbm_stack['vis--pen'].update_recognize_params(pen_vis_out, v_k[:, n_labels:], pred_sleep_pen_p)
